...
if "bpy" in locals():
    ...
    from . import image_ops, bake_common, modifier_common, Decal, BakePath, ui, subtree, transition_common, input_outputs, node_arrangements, node_connections
