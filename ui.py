...
from . import lib, Modifier, MaskModifier, UDIM, ListItem, Decal, BakePath
from .common import *
...
def draw_layer_source(context, layout, layer, layer_tree, source, image, vcol, is_a_mesh):
    ...
    # Path / ribbon bake (real 3D Bezier → UV image)
    if layer.type == 'IMAGE':
        rcol.separator()
        BakePath.draw_path_bake_ui(rcol, context, layer)
