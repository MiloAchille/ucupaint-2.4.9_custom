...
from . import Modifier, lib, Mask, transition, ImageAtlas, UDIM, NormalMapModifier, ListItem, BaseOperator, Decal, BakePath
from .common import *
...
class YLayer(bpy.types.PropertyGroup, Decal.BaseDecal, BakePath.BaseBakePath):
    name : StringProperty(
        name = 'Layer Name',
